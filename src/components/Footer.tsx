...
const Footer = () => {
  ...
  return (
    <footer className="bg-spice-cardamom text-white py-16 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="#AboutSection" className="text-white/80 hover:text-white transition-colors">About Us</a>
              </li>
              <li>
                <a href="#productcollection" className="text-white/80 hover:text-white transition-colors">Our Products</a>
              </li>
              <li>
                <a href="#ClientsSection" className="text-white/80 hover:text-white transition-colors">Our Presence</a>
              </li>
              <li>
      ...
      <div className="absolute top-20 right-20 w-40 h-40 rounded-full bg-spice-saffron/5 blur-3xl opacity-30"></div>
      <div className="absolute bottom-20 left-20 w-40 h-40 rounded-full bg-spice-turmeric/5 blur-3xl opacity-30"></div>
    </footer>
  );
};
